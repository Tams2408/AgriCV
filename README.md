...
Sistema que recomenda culturas agrícolas para Cabo Verde.
...
Autores: Natalino Semedo, Tamiris Évora e David Santos
...
2. Instalar SWI-Prolog (https://swi-prolog.org)
3. Instalar a biblioteca: pip install pyswip
...
Durante o desenvolvimento e revisão do projeto, foram identificados e corrigidos 6 erros. Todos foram resolvidos e aplicados no código final. 
...
O AgriCV é uma aplicação prática dos conceitos de Programação em Lógica, demonstrando como sistemas baseados em regras podem resolver problemas reais. O projeto mostra de forma clara a divisão correta de responsabilidades entre Python e Prolog: o Python cuida da interface e da interação, enquanto o Prolog cuida do conhecimento e da inferência. Durante o desenvolvimento foram identificados e corrigidos oito erros e implementadas seis melhorias que tornam o AgriCV mais útil para a realidade agrícola de Cabo Verde. A base de conhecimento foi expandida com novas culturas, corrigida nas ilhas com dados inadequados.
